...
29. get_delivery_context  - compact deterministic delivery evidence
"""
...
# -- delivery ---------------------------------------------------------------
from .delivery import format_delivery_context_text, get_delivery_context
